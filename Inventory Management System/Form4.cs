...
namespace Inventory_Management_System
{
	public partial class Form4 : Form
	{
		...
		// Update an exisiting part
		private void UpdatePart()
		{
			if (isInhouse)
			{
				Inhouse inhousePart = new Inhouse(Convert.ToInt32(textBox1.Text), textBox2.Text, Convert.ToDecimal(textBox4.Text), Convert.ToInt32(textBox3.Text), Convert.ToInt32(textBox6.Text), Convert.ToInt32(textBox8.Text), Convert.ToInt32(textBox7.Text));
				Inventory.Swap(inhousePart);
			}
			else
			{
				Outsourced outsourcedPart = new Outsourced(Convert.ToInt32(textBox1.Text), textBox2.Text, Convert.ToDecimal(textBox4.Text), Convert.ToInt32(textBox3.Text), Convert.ToInt32(textBox6.Text), Convert.ToInt32(textBox8.Text), textBox7.Text);
